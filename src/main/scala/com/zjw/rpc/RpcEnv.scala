...
import com.zjw.rpc.netty.NettyRpcEnvFactory
import com.zjw.util.RpcUtils
 ...
 */
private[zjw] abstract class RpcEnv(conf: RpcConf) {

  private[zjw] val defaultLookupTimeout = RpcUtils.lookupRpcTimeout(conf)
 ...
 */
private[zjw] trait RpcEnvFileServer {
...
private[zjw] case class RpcEnvConfig(
                                        conf: RpcConf,
                                        name: String,
                                        bindAddress: String,
                                        advertiseAddress: String,
