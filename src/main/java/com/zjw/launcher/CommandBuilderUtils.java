...
class CommandBuilderUtils {
  ...
  /**
   * Returns the first non-empty value mapped to the given key in the given maps, or null
   * otherwise.
   */
   ...
   * needs quoting. Arguments only seem to need quotes in batch scripts if they have certain special
   * characters, some of which need extra (and different) escaping.
   * <p>
  ...
  /**
   * Quotes a string so that it can be used in a command string. Basically, just add simple escapes.
   * E.g.: original single argument : ab "cd" ef after: "ab \"cd\" ef"
   * <p>
  ...
  /**
   * Get the major version of the java version string supplied. This method accepts any
   * JEP-223-compliant strings (9-ea, 9+100), as well as legacy version strings such as 1.7.0_79
   */
  ...
  /**
   * Find the location of the Spark jars dir, depending on whether we're looking at a build or a
